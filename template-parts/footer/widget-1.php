...
$heading = get_field( 'widget_1_heading', 'option' );

if ( ! $heading && ! have_rows( 'widget_1_links', 'option' ) ) {
	return;
}
?>
<div class="f-widget">
	...
	if ( have_rows( 'widget_1_links', 'option' ) ) :

		echo '<div class="links"><ul class="text-lg font-bold uppercase space-y-4">';

		while ( have_rows( 'widget_1_links', 'option' ) ) :
			the_row();

			$links = get_sub_field( 'widget_1_link' );
