<?php
/**
 * The template for displaying Search results of knowledge bank posts
 *
...
<?php get_template_part( 'template-parts/knowledge/search', 'title' ); ?>

<section class="knowledge mb-20 lg:mb-26">
	<div class="container">

		<?php get_template_part( 'template-parts/knowledge/filters' ); ?>

		<div class="about-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-20 mb-20 lg:mb-26">
