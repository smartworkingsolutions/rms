<?php
/**
 * The template for displaying knowledge_category Taxonomies
 *
...
<section class="knowledge">
	<div class="container">
		...
		<div class="about-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-20 mb-26">
